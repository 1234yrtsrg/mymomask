...
def arg_parse(is_train=False):
    ...
    ## dataloader
    parser.add_argument('--dataset_name', type=str, default='blendshape', help='dataset identifier')
    parser.add_argument('--data_root', type=str, default='./dataset/blendshape', help='dataset root directory')
    parser.add_argument('--motion_dir', type=str, default='', help='directory containing normalized motion numpy files')
    parser.add_argument('--batch_size', default=256, type=int, help='batch size')
    parser.add_argument('--window_size', type=int, default=64, help='training motion length')
    parser.add_argument("--gpu_id", type=int, default=0, help='GPU id')
    parser.add_argument("--num_gpus", type=int, default=1, help='number of GPUs for a single training run')
    parser.add_argument("--master_port", type=int, default=29500, help='master port used for distributed training')
    parser.add_argument("--num_workers", type=int, default=4, help='number of dataloader workers per process')
    ...
    ## vqvae arch
    parser.add_argument("--input_width", type=int, default=61, help="input feature dimension per frame")
    parser.add_argument("--output_width", type=int, default=61, help="output feature dimension per frame")
